...
enum AkCallbackType
{
	...
	AK_MIDIEvent					= 0x8000,	///< Enable notifications for MIDI events. AkCallbackInfo can be cast to AkMIDIEventCallbackInfo.

	AK_Callback_Last				= 0x10000,	///< Last calblack unused bit, invalid value.
