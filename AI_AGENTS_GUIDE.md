...
- Cursor Composer 세션에서는 **에이전트 B가 단독으로** 문서 정비, Git 설정, C++ 스켈레톤 등을 수행하는 경우가 많습니다.
- **게임플레이·사운드 연동** 작업은 원칙적으로 **D 검토 → 임무 배분 후** A·B·C가 착수합니다.
- **지침·인프라** 등 소규모 작업은 KiHoon **직접 지시**로 D 단계를 생략할 수 있습니다.
