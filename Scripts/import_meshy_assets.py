...
def run():
    ...
    unreal.log("  - /Game/Characters/Player/Mesh/")
    unreal.log("  - /Game/Characters/Player/Textures/")
    unreal.log("  - /Game/Weapons/Sword/Mesh/")
    unreal.log("  - /Game/Weapons/Sword/Textures/")
    unreal.log("=" * 60)
